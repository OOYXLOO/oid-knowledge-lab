...
- Draft.dev application field pack: <https://ooyxloo.github.io/oid-knowledge-lab/draftdev-application-field-pack.html>
...
- Airbyte submission rewrite worksheet: <https://ooyxloo.github.io/oid-knowledge-lab/airbyte-submission-rewrite-worksheet.html>
- Airbyte form field pack: <https://ooyxloo.github.io/oid-knowledge-lab/airbyte-form-field-pack.html>
...
- Proposal Router case study: <https://ooyxloo.github.io/oid-knowledge-lab/proposal-router-case-study.html>
...
- `docs/articles/publication-proposal-static-evidence-dashboard.md`
...
- `reports/vertical-use-case-pack.json`
- `reports/vertical-use-case-pack.md`

The pack maps the assessment workflow to three concrete review contexts: SNMP/MIB vendor PEN inventory, PKI certificate policy OID review, and internal OID registry cleanup. It reuses the sample audit, public coverage report, and source-policy boundary so the guidance stays tied to verifiable artifacts instead of broad marketing copy.
