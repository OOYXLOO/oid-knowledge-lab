...
11. `reports/statement-of-work-pack.md`：看更正式的工作边界、交付物、客户责任和变更控制。
12. `reports/sample-delivery-pack.md`：看未来可以交付给客户的报告形态。
13. `docs/authorized-full-crawl.zh.md`：如果以后拿到授权，再看全量正文采集流程。
