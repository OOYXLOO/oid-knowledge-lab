...
function buildQwenSubmissionPack(options = {}) {
  ...
  return {
    ...
    proof_checklist: [
      ...
      { label: "Redacted Qwen run receipt generator", status: "ready_source_only", evidence: "src/qwenReceipt.js" },
      { label: "Live Qwen run", status: "needs_live_key", evidence: "Requires a private Qwen API key and redacted response receipt" },
