...
function renderArticleSamplesPanel() {
  return `<section class="panel article-samples-panel">
      <div>
        ...
        <p class="panel-copy">Review long-form engineering samples and templates about static evidence dashboards, publish guards, public issue triage, observability handoffs, client-safe data boundaries, and OID inventory assessment workflows.</p>
      </div>
      <table class="handoff-table">
