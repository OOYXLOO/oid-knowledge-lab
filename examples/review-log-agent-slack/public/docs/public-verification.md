...
- The source snapshot exposes reviewable source/test/doc copies and SHA-256 hashes while the standalone GitHub repository is still pending.
...
- Public GitHub repository URL for this standalone project.
